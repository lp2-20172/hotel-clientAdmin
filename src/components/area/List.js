...
import { getList, del } from '../../actions/area-action'
...
class List extends Component {
    ...
    handleClick = () => {
        this.props.history.push('/catalogo/areas/new');
    }
                            ...
                            <TableBody>
                                {list.map((d, index) =>
                                    <TableRow key={index}>
                                        ...
                                        <TableCell >{d.detalle_area}</TableCell>
                                        <TableCell >
                                            <Link to={`/catalogo/areas/edit/${d.id}`}>Edit</Link>
                                        </TableCell>
                                        <TableCell >
